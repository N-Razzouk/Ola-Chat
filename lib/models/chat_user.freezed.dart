...
/// @nodoc
class __$$_ChatUserCopyWithImpl<$Res> extends _$ChatUserCopyWithImpl<$Res>
    implements _$$_ChatUserCopyWith<$Res> {
  __$$_ChatUserCopyWithImpl(
      _$_ChatUser _value, $Res Function(_$_ChatUser) _then)
      : super(_value, (v) => _then(v as _$_ChatUser));

  @override
  _$_ChatUser get _value => super._value as _$_ChatUser;
...
class _$_ChatUser extends _ChatUser {
  const _$_ChatUser({required this.id, required this.name, required this.image})
      : super._();
  ...
  @override
  String toString() {
    return 'ChatUser(id: $id, name: $name, image: $image)';
  }
...
abstract class _ChatUser extends ChatUser {
  const factory _ChatUser(
      ...
      required final String image}) = _$_ChatUser;
